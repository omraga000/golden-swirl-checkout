...
export const PRODUCTS: CatalogProduct[] = [
  ...
  { id: "3", name: "Aventus Legacy",   collection: "The Oud Legacy",    description: "Blackcurrant, pineapple and birch smoke.",          sensory: "Blackcurrant, cut pineapple and smoked birch bark over rich oakmoss.",       price: 17,  image: m3.url, category: "men",     season: "new",    notes: ["Smoky","Citrus","Woody"], bestseller: true, sizes: [{ size: "20ML", price: 17 }, { size: "50ML", price: 27 }, { size: "100ML", price: 37 }] },
  { id: "4", name: "Tygar Extrait",    collection: "Nights of Arabia",  description: "Amalfi dusk, gold leather and sea salt.",           sensory: "Gilded leather and warm amber under a Positano dusk of salt and citrus.",   price: 12,  image: m4.url, category: "oud",     season: "winter", notes: ["Leather","Amber","Woody"], bestseller: true, sizes: [{ size: "20ML", price: 12 }, { size: "50ML", price: 22 }, { size: "100ML", price: 32 }] },
  { id: "5", name: "Stronger Amber",   collection: "Golden Essences",   description: "Warm amber, vanilla and velvet.",                   sensory: "Molten amber, dark vanilla and velvet musk on skin.",                        price: 12,  image: m5.url, category: "men",     season: "winter", notes: ["Amber","Musk","Spicy"], sizes: [{ size: "20ML", price: 12 }, { size: "50ML", price: 22 }, { size: "100ML", price: 32 }] },
